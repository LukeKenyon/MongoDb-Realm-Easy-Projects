...
@dso_cache = dso_local local_unnamed_addr global [56 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		...
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.1_name, ; name: libDXChartsNative.so
		ptr null; void* handle (0x0)
	}, ; 3
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		...
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.2_name, ; name: libDXSchedulerNative.so
		ptr null; void* handle (0x0)
	}, ; 16
	%struct.DSOCacheEntry {
...
@.env.7 = private unnamed_addr constant [37 x i8] c"8f88096d-53dd-4a9b-ae1e-4e6dfd422932\00", align 16
...
;ApplicationConfig
@.ApplicationConfig.0_android_package_name = private unnamed_addr constant [33 x i8] c"com.companyname.eProjectsOnRealm\00", align 16

;DSOCacheEntry
@.DSOCacheEntry.0_name = private unnamed_addr constant [21 x i8] c"librealm-wrappers.so\00", align 16
@.DSOCacheEntry.1_name = private unnamed_addr constant [21 x i8] c"libDXChartsNative.so\00", align 16
@.DSOCacheEntry.2_name = private unnamed_addr constant [24 x i8] c"libDXSchedulerNative.so\00", align 16
